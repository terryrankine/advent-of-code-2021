data = '''dg debg edgfc afbgcd efdbgc gdc bfdceag bfdec febcad gfaec | dcg bdaegfc egbd dcgfe
...
cgbaf dbagf da gdcfbae febdg gbfeca bdca cdegaf gfdacb fad | cgafbd bcafg fbdga badc'''.splitlines()

seq = []
ans = []
newline =[]
for idx, line in enumerate(data):
    for item in line.split('|')[0].strip().split(' '):
